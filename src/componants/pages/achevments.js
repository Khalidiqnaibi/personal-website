        ...
        <div className="row">
          <div className="item">
            <a className='tili' rel="noopener noreferrer"  target="_blank" href="https://www.amideast.org/west-bank-gaza/learn-english/english-for-kids-and-teens/english-access-microscholarship-access-program">
             ...
             <div className='con'>
            <a className='tili' rel="noopener noreferrer"  target="_blank" href="https://www.amideast.org/west-bank-gaza/learn-english/english-for-kids-and-teens/english-access-microscholarship-access-program"><h3>Acsess schoolarship</h3></a>
            
            <p className='pr'>Khalid completed the acsess scholarship 2018-2019</p>
            </div>
          </div>
          <div className="item">
           ...
           <div className='con'>
            ...
            <p className='pr'>Khalid won a programming contest when he was 15 in his school</p>
           </div>
          </div>
          <div className="item">
            ...
            <p className='pr'>Khalid graduated from the best schools in his country with amazing grades</p>
            </div>
          </div>
          <div className="item">
           ...
           <div className='con'>
            ...
            <p className='pr'>Khalid learned scrach,html,css,javascript,python and c++</p>
            </div>
           </div>
        </div>
      </div>
